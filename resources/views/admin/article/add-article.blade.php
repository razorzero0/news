        ...
        <div class="p-8 bg-white border-2 rounded-lg ">
            <div class="bg-white rounded ">
                <div class="text-center ">
                    <h4 class="text-2xl font-bold">Buat Artikel</h4>
                </div>
                @if ($errors->any())
                ...
                <form method="post" action="{{ route('article.store') }}" class="max-w-xl pt-4 mx-auto sm:max-w-4xl"
                    ...
                    <div class="mb-5">
                        ...
                        <textarea id="wsgi" name="content"></textarea>
                    </div>
                    <div class="mb-5">
                        <label class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Ringkasan /
                            Summary</label>
                        <textarea class="w-full" maxlength="150" name="excerpt"></textarea>
                    </div>
                    <div class="mb-5">
                        <label for="image" class="block mb-2 text-sm font-medium text-gray-900">Upload Gambar
                            Thumbnail</label>
                        <input id="image"
                            class="block w-full mb-5 text-xs text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                            id="small_size" type="file" name="image" required>
