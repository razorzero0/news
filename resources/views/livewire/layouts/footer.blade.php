<footer class=" relative mt-32">
    <img src="{{ asset('assets/img/bg-wave.svg') }}" class="w-full absolute bottom-0 -z-10" />
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:pt-8 ">
        <div class="md:flex md:justify-around">
            <div class="mb-6 md:mb-0 flex-1">
                ...
                <div class="md:w-[80%] text-xs sm:text-sm text-justify text-slate-200 mt-2">
                    <p>Algoora News hadir sebagai portal berita terpercaya yang menyajikan informasi terkini dan
                        mendalam di berbagai bidang, termasuk dunia cryptocurrency, bisnis, teknologi, dan banyak lagi.
                        Kami memahami bahwa di era digital ini, kebutuhan akan informasi yang cepat, akurat, dan relevan
                        semakin meningkat, terutama dalam menghadapi perkembangan dunia yang terus berubah dengan
                        dinamis. </p>
                </div>
            </div>
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                ...
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-gray-300 uppercase ">Legal</h2>
                    <ul class="text-gray-500 dark:text-gray-400 font-medium">
                        <li class="mb-4">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="#"
                    class="hover:underline">Algoora</a>. All Rights Reserved.
            </span>
