<div class="mt-12">
    <div class="flex justify-between mb-5 text-sm border-b border-slate-700">
        <div class="flex items-center pb-2 pr-2 uppercase text-slate-100">

            <a href="#" class="inline-block font-bold text-md">Latest Post</a>
        </div>
    ...
    <div class="grid grid-cols-1 gap-10 sm:grid-cols-2 md:grid-cols-3">
        ...
        @foreach ($articles as $article)
            <div class="flex flex-col overflow-hidden rounded shadow-lg bg-slate-800 shadow-slate-950">
                ...
                <div class="flex flex-row flex-wrap items-center justify-between px-6 py-3 bg-slate-900 text-slate-300">
                    ...
                    <span href="#" class="flex flex-row items-center py-1 mr-1 text-xs font-light">
