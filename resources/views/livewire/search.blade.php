<div class="relative max-w-screen-xl p-5 mx-auto mt-20 md:mt-20 sm:p-10 md:p-16">
    ...
    <div class="">
        <div class="flex justify-between mb-5 text-sm border-b border-slate-700">
            <div class="flex items-center pb-2 pr-2 text-slate-100 ">
                ...
                <p href="#" class="inline-block text-lg font-bold">Pencarian untuk <i>"{{ $query }}"</i></p>
            </div>
        ...
        @else
            <p class="text-center text-slate-400">Tidak ada artikel terkait</p>
        @endif
    </div>
</div>
