<section class="py-20 mt-8 sm:mt-10 ">
                    ...
                    <div class="relative group">
                        ...
                        <div class="relative leading-none text-white rounded-lg bg-slate-800 ring-1 ring-gray-900/5">
                            <div class="flex overflow-hidden font-bold rounded-t-lg bg-slate-700 text-md ">
                                ...
                                <p class="w-full p-5 text-center text-purple-100 ps-7 sm:ps-12">

                                    <span class="text-lg font-bold sm:text-xl">Beri Masukan Kepada
                                        Kami</span>
                                </p>
                            </div>
                            <div class="pt-4 text-left p-7 sm:text-center ">
                                ...
                                <div class="mb-4 text-left">
                                    <label for="name" class="leading-7 text-gray-200 text-md">Nama</label>
                                ...
                                <div class="mb-4 text-left">
                                    <label for="email" class="leading-7 text-gray-200 text-md">Email</label>
                                    <input wire:model="email" type="email" id="email" name="email"
                                        class="w-full px-3 py-1 text-base leading-8 text-gray-700 transition-colors duration-200 ease-in-out bg-white border border-gray-300 rounded outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200"
                                        placeholder="example@gmail.com" />
                                </div>
                                <div class="mb-4 text-left">
                                    <label for="message" class="leading-7 text-gray-200 text-md">Message</label>
                                ...
                                <div class="flex justify-end">
                                    ...
                                    <button wire:click="sendEmail"
                                        class="px-10 py-2 mt-3 text-lg text-white bg-purple-700 border-0 rounded-lg hover:bg-purple-800 focus:outline-none"><span
                                            wire:loading.remove>
                                            Kirim Pesan
                                        </span>
                                        <div wire:loading>
